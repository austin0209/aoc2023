class CubeSet(val blue: Int, val red: Int, val green: Int) {
    ...
    for (l in lines) {
        ...
        val sets = split[1]
            ...
            .map { setInfo ->
                ...
                for (info in setInfo) {
                    when (info[1]) {
                        "blue" -> blue = info[0].toInt()
                        "red" -> red = info[0].toInt()
                        "green" -> green = info[0].toInt()
                    }
                }
...
private const val SAMPLE_INPUT = """Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue
Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red
Game 4: 1 green, 3 red, 6 blue; 3 green, 6 red; 3 green, 15 blue, 14 red
Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green"""

private const val INPUT = """Game 1: 9 red, 5 blue, 6 green; 6 red, 13 blue; 2 blue, 7 green, 5 red
